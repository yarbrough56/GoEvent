...
public class TicketMasterAPI {
	...
	//myAPIKEY
	private static final String API_KEY = "hzVTfIohfrxB8Pl1P9Rny26J4ZrGHF7G";
	...
	private Set<String> getCategories(JSONObject event) throws JSONException {
		//classification cannot be repeated 
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// apikey=hzVTfIohfrxB8Pl1P9Rny26J4ZrGHF7G&geoPoint=abcd&keyword=&radius=50
